...
export default function Hero() {
  ...
  const fullText = 'Etudiant IT & Cybersécurité';
  ...
  return (
    <section 
      ...
      style={{
        backgroundImage: `url('/images/IMG_0756.png')`,
      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8 animate-fade-in">
            {/* Suppression de l'image ici car elle est maintenant en background */}
            <p className="text-sm text-gray-300 mb-6">Bienvenue sur mon portfolio</p>
          </div>
